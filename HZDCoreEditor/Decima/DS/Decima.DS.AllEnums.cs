...
namespace Decima.DS
{
	...
	[RTTI.Serializable(0x69467FBEB640D817, GameType.DS)]
	public enum DeferredRenderTargets : int32
	{
		Albedo = 1,
		SunlightOcclusion = 2,
		Lighting = 4,
		LightIntensity = 8,
		Normal = 16,
		TranslucencyFactor = 64,
		TranslucencyDiffusion = 128,
		MotionVectors = 32,
		Reflectance = 256,
		Roughness = 512,
		MaterialID = 1024,
		...
		DeferredTarget2 = 16,
		DeferredTarget3 = 736,
		DeferredTarget4 = 1280,
	}

	[RTTI.Serializable(0x42D417C2D6A786A1, GameType.DS)]
	public enum E3DTexNodeSampler : int32
	{
		...
		SamplerCube = 4,
		SamplerCubeWithDynamicSkyMask = 5,
	}

	[RTTI.Serializable(0x81021D7C336570DB, GameType.DS)]
	public enum EAAMode : uint32
	{
		None = 0,
		FXAA = 1,
		TAA = 2,
	...
	[RTTI.Serializable(0xABBE0DC49C549914, GameType.DS)]
	...
	[RTTI.Serializable(0x9CD02B9CFFF1F3BF, GameType.DS)]
	...
	[RTTI.Serializable(0x9CE1BD53A2B599CA, GameType.DS)]
	...
	[RTTI.Serializable(0x3AD7EB51572DF91E, GameType.DS)]
	...
	public enum EActiveView : uint32
		{
		None = 4294967295,
		Default = 0,
		ThirdPerson = 1,
	...
	[RTTI.Serializable(0xDD228E23FA3D5936, GameType.DS)]
	...
	[RTTI.Serializable(0xF8393DF8C4DF39D2, GameType.DS)]
	...
	[RTTI.Serializable(0x4248137C6512B3C8, GameType.DS)]
	public enum EAmbienceWeightMode : int32
	{
		Linear = 0,
		Forward = 1,
		Smooth = 2,
	...
	[RTTI.Serializable(0xC33D2B5B0F05E2FB, GameType.DS)]
	...
	[RTTI.Serializable(0xA44B5334C21090F8, GameType.DS)]
	public enum EAnimLayerMode : int8
	{
		Base = 0,
		Blend = 1,
		AddToPrevious = 2,
	...
	public enum EAnimationDamageType : uint32
		{
		none = 4294967295,
		projectile = 0,
		explosion = 2,
	...
	[RTTI.Serializable(0x943171130411AE4B, GameType.DS)]
	...
	public enum EAnimationDirection : uint32
	{
		any = 4294967295,
		front = 0,
		back = 1,
	...
	[RTTI.Serializable(0x37E852731AAFA991, GameType.DS)]
	public enum EArtPartsPreviewEyeAdjust : int32
	{
		PlayerCamera = 0,
		FaceFront = 1,
		Disable = 2,
	...
	[RTTI.Serializable(0x22C51D61C8028051, GameType.DS)]
	public enum EArtPartsPreviewLipSync : int32
	{
		Repeat = 0,
		Inc = 1,
		Dec = 2,
	...
	[RTTI.Serializable(0x5212CAE85A2E39EB, GameType.DS)]
	public enum EAssetPool : int8
	{
		MainRAM = 0,
		VRAM = 1,
	}

	[RTTI.Serializable(0x2C4A66E6CC3B42DD, GameType.DS)]
	public enum EAsyncComputeContextIdentifier : int32
	{
		ASYNC_RenderDataStreamingCheckActivation = 0,
		ASYNC_RenderDataStreamingComputePriority = 1,
		ASYNC_OcclusionFinishCapture = 2,
		ASYNC_StaticSceneCulling = 3,
		ASYNC_SoundObstructionScanner = 4,
		ASYNC_WorldDataCompute = 5,
		ASYNC_DSTarEffectMesh = 6,
		ASYNC_DSTextureReader = 7,
		ASYNC_Count = 8,
		ASYNC_Max = 255,
	}
	...
	[RTTI.Serializable(0x1EB40B183DF44C16, GameType.DS)]
	public enum EAudioLanguageCategory : uint32
		{
		Invalid = 4294967295,
		English = 0,
		French = 1,
	...
	[RTTI.Serializable(0x547AA365CE7E3F2F, GameType.DS)]
	public enum EBackgroundTableImage : uint32
		{
		_0 = 4294967295,
		top_left = 0,
		top_middle = 1,
	...
	[RTTI.Serializable(0xA9DC04545EFCF314, GameType.DS)]
	...
	[RTTI.Serializable(0x36228287D4F29374, GameType.DS)]
	...
	[RTTI.Serializable(0x498C4EC64C80C9DC, GameType.DS)]
	...
	[RTTI.Serializable(0xD343D65CAB88599, GameType.DS)]
	...
	[RTTI.Serializable(0x9685147DF67C4A4, GameType.DS)]
	...
	[RTTI.Serializable(0xF5639C4E98BDA137, GameType.DS)]
	public enum EBolaReticleAimState : int8
	{
		NoTarget = 1,
		Aiming = 2,
	}

	[RTTI.Serializable(0xBFD4E7C58F0D1620, GameType.DS)]
	public enum EBolaReticleShotMode : int8
	{
		Invisible = 0,
		Stun = 1,
		Bola = 2,
	...
	[RTTI.Serializable(0xF50702DD356B46BB, GameType.DS)]
	public enum EBreathingState : uint32
		{
		Not_Set = 4294967295,
		None = 0,
		Slow = 1,
	...
	[RTTI.Serializable(0x70ABFCB775446A9A, GameType.DS)]
	...
	[RTTI.Serializable(0x1C5056B49143780A, GameType.DS)]
	...
	[RTTI.Serializable(0x1039137E87836080, GameType.DS)]
	...
	public enum ECarryModes : uint32
		{
		INVALID = 4294967295,
		IDLE = 0,
		TACTICAL = 1,
	...
	[RTTI.Serializable(0xD274A9966FD69B48, GameType.DS)]
	...
	[RTTI.Serializable(0x8FFD6ED7428BBD8B, GameType.DS)]
	...
	[RTTI.Serializable(0x69E5FCDB67AB44B9, GameType.DS)]
	...
	[RTTI.Serializable(0xCC3CFCC01A4B61F9, GameType.DS)]
	...
	[RTTI.Serializable(0xEDAEE9C8FAABB8ED, GameType.DS)]
	...
	[RTTI.Serializable(0x9307F301D85AB770, GameType.DS)]
	...
	[RTTI.Serializable(0x29011659046C5891, GameType.DS)]
	...
	[RTTI.Serializable(0x7147D5E417749A77, GameType.DS)]
	public enum EDPadDirection : int8
	{
		Up = 0,
		Left = 1,
		Down = 2,
	...
	public enum EDSAmmoType : uint32
		{
		Unknown = 4294967295,
		Rifle = 0,
		ShotGun = 1,
	...
	[RTTI.Serializable(0x80A6DB06C11B59E9, GameType.DS)]
	public enum EDSBridgeType : int8
	{
		Normal = 0,
		NetNormal = 1,
	}
	...
	[RTTI.Serializable(0xD9E213B56293E85, GameType.DS)]
	public enum EDSCalcEvaluationInputParam : int32
	{
		InputInfo = 0,
		OutputInfo = 1,
		OutputMultiInfo = 2,
	...
	[RTTI.Serializable(0x3591D1224C2A446, GameType.DS)]
	public enum EDSCalcEvaluationOutputParam : int32
	{
		OutputInfo = 0,
	}
	...
	[RTTI.Serializable(0x1FFE36EEE62D5F3C, GameType.DS)]
	public enum EDSCatalogueListItem_RelationshipNpcId : int32
	{
		None = 0,
		PR201 = 2201,
		PR202 = 2202,
	...
	[RTTI.Serializable(0xBCCE27BD159BD234, GameType.DS)]
	public enum EDSCollectibleMarkerType : int8
	{
		None = 0,
		Crystal = 1,
		ShoeSoleGrass = 2,
	...
	[RTTI.Serializable(0x4527F15292745FB1, GameType.DS)]
	public enum EDSConstructionNGMarkerType : int8
	{
		None = 0,
		ZiplineObstacle = 1,
	}
	...
	public enum EDSCountTimerState : uint32
		{
		STATE_NONE = 4294967295,
		STATE_COUNT_RUN = 0,
		STATE_COUNT_PAUSE = 1,
	...
	[RTTI.Serializable(0x16EDE3174C6905CC, GameType.DS)]
	public enum EDSDeviceTopMenuItemName : int8
	{
		BAGGAGE_SELECT = 0,
		ORDER_SELECT = 1,
		ORDER_AUTO = 2,
		...
		SYSTEM_DASHBOARD = 8,
		DEPOSITED_BAGGAGE = 9,
		PRIVATEROOM_COLOR = 10,
	}

	[RTTI.Serializable(0xF0B93456B802145D, GameType.DS)]
	public enum EDSDeviceTopMenuItemStatus : int8
	{
		Enabled = 0,
		Disabled = 1,
		Hidden = 2,
	...
	[RTTI.Serializable(0x53AE0ACD49E12B6A, GameType.DS)]
	public enum EDSEchoMarkerType : int8
	{
		None = 0,
		Baggage = 1,
		Vehicle = 2,
	...
	public enum EDSEvaluationType : uint32
		{
		Unset = 4294967295,
		Speed = 0,
		Safety = 1,
	...
	[RTTI.Serializable(0xCA52031FED031D08, GameType.DS)]
	public enum EDSFieldRopeType : int8
	{
		Normal = 0,
		NetNormal = 1,
		StageNormal = 2,
	...
	[RTTI.Serializable(0x279A1FF42B393F02, GameType.DS)]
	public enum EDSFriendshipLevelUpInputParam : int32
	{
		DSHouseholdInfoResource = 0,
		PreviouLevel = 1,
		CurrentLevel = 2,
		DiffLevel = 3,
		DeliveryPointID = 4,
	...
	[RTTI.Serializable(0xE742409D66010D2C, GameType.DS)]
	public enum EDSFriendshipLevelUpOutputParam : int32
	{
		QpidState = 0,
		QpidLevelUpEvent = 1,
	}
	...
	public enum EDSFunction : uint32
		{
		kDSFunction_None = 4294967295,
		DS_PAD_HOLD = 0,
		DS_PAD_SHOOT = 1,
	...
	public enum EDSFunctionKeyBindStickOutputPropertyOverwriteTarget : uint32
		{
		kNone = 4294967295,
		kStickLeft = 0,
		kStickRight = 1,
	...
	[RTTI.Serializable(0x11E94CDC4BC69316, GameType.DS)]
	...
	[RTTI.Serializable(0xC03001E13719894A, GameType.DS)]
	public enum EDSInputDeviceType : int8
	{
		None = 0,
		Keyboard_QWERTY = 1,
		Keyboard_AZERTY = 2,
	...
	[RTTI.Serializable(0x104D2A96C3B06B12, GameType.DS)]
	public enum EDSMailInfoState : int8
	{
		UnSent = 0,
		Sent = 1,
		Recive = 2,
	...
	[RTTI.Serializable(0x930716D270BA02B3, GameType.DS)]
	public enum EDSMarkerType : int8
	{
		None = 0,
		Player = 1,
		Baggage = 2,
	...
	[RTTI.Serializable(0x97E1CE444431C935, GameType.DS)]
	public enum EDSMaterialConfigLevel : int16
	{
		Level1 = 0,
		Level2 = 1,
		Level3 = 2,
	...
	[RTTI.Serializable(0x57B2693DC8BDD9F2, GameType.DS)]
	public enum EDSMissionState : int16
	{
		Invalid = 0,
		Available = 1,
		Ready = 2,
	...
	[RTTI.Serializable(0x506156822B2EBAEB, GameType.DS)]
	public enum EDSMuleMarkerType : int8
	{
		None = 0,
		Dead = 1,
		Sleeping = 2,
	...
	[RTTI.Serializable(0xC8D1264AD4A97B62, GameType.DS)]
	public enum EDSMuleOdradekMarkerType : int8
	{
		None = 0,
		Alert = 1,
		AlertPlayerLost = 2,
	...
	[RTTI.Serializable(0x62375937930383B0, GameType.DS)]
	public enum EDSNPCMarkerType : int8
	{
		None = 0,
		Fragile = 1,
		Tower = 2,
	...
	[RTTI.Serializable(0xC63139151841CA1D, GameType.DS)]
	public enum EDSNextMarkerType : int8
	{
		None = 0,
		__0 = 1,
		__1 = 2,
	...
	[RTTI.Serializable(0x85C8AB5A7F583A1, GameType.DS)]
	public enum EDSNpcLookAtRequestType : int8
	{
		UpperBodyLook = 0,
		HeadOnlyLook = 1,
		Aim = 2,
	...
	[RTTI.Serializable(0xD42EC12D5040D531, GameType.DS)]
	public enum EDSOnlineMissionType : int8
	{
		Unknown_Online_Type = 0,
		Online_Supply = 1,
		Private = 2,
		Dynamic = 3,
		Static = 4,
		Shared_Last_Stranding = 5,
	}
	...
	[RTTI.Serializable(0x60C43FDEE8DCA459, GameType.DS)]
	public enum EDSPatrolActionName : int16
	{
		ERROR = 0,
		_Loop_Idle = 1,
		Message = 2,
	...
	[RTTI.Serializable(0x55ADBD28AC25D417, GameType.DS)]
	public enum EDSPatrolCliffActionName : uint16
	{
		ERROR = 0,
		_Loop_Idle = 1,
		Message = 2,
		FormationGathering = 12288,
		FirePoseIdle = 4096,
		CoverCheck = 4097,
		CoverCheckUp = 4098,
		CoverPeep = 4099,
		CoverPeepUp = 4100,
		LookAroundAction = 32768,
		PleaseChnageToNewHandSignGo = 32769,
		HandSignGo = 32832,
		HandSignGather = 32833,
		HandSignSearch = 32834,
		HandSignWait = 32835,
		HandSignCome = 32836,
		HandSignHurry = 32837,
		Cigarette = 32838,
	...
	[RTTI.Serializable(0x6CA4E8889C4F843D, GameType.DS)]
	public enum EDSPatrolMuleActionName : uint16
	{
		ERROR = 0,
		_Loop_Idle = 1,
		Message = 2,
		...
		ScratchHead = 32772,
		CheckWeapon = 32773,
		LookAroundAction2 = 32774,
		LookRight = 32775,
		LookLeft = 32776,
		RelaxWaist = 32777,
		CheckWeather = 32778,
		CheckPost = 32779,
		CheckTruckDown = 32780,
		CheckTruckStand = 32781,
		CheckTruckTire = 32782,
		CheckShoes = 32783,
		CheckToolChest = 32784,
		_Loop_CuriouslyLookFar = 32800,
		_Loop_CuriouslyLookNear = 32801,
		_Loop_RestSitGround = 32802,
		_Loop_RestSitChair1 = 32803,
		_Loop_RestSitChair2 = 32804,
		_Loop_RestSitChair3 = 32805,
		RandomRelax_NoTurnBack = 36864,
	}

	[RTTI.Serializable(0x7296C12E383250AC, GameType.DS)]
	public enum EDSPatrolMuleVehicleActionName : int16
	{
		ERROR = 0,
		_Loop_Idle = 1,
		Message = 2,
	...
	[RTTI.Serializable(0xE85604D832D83E1F, GameType.DS)]
	public enum EDSPatrolWarriorActionName : uint16
	{
		ERROR = 0,
		_Loop_Idle = 1,
		Message = 2,
		DieRandomPose = 8192,
		Dying = 8193,
		_Loop_FirePoseIdle = 4106,
		_Loop_SquatFirePoseIdle = 4110,
		_Loop_Shoot = 4096,
		_Loop_SquatShoot = 4118,
		ThrowGrenade = 4097,
		_Loop_CoverIdleLeft = 4098,
		_Loop_CoverIdleRight = 4103,
		_Loop_StandCoverIdleLeft = 4101,
		_Loop_StandCoverIdleRight = 4102,
		_Loop_CoverShoot = 4100,
		_Loop_CoverShootForward = 4099,
		_Loop_FixedGunShoot = 4104,
		_Loop_FixedGunIdle = 4105,
		CoverHalfRisingPoseShoot = 4107,
		CoverGettingOutShoot = 4108,
		CoverSquatShootHigh = 4109,
		_Loop_CoverCheck = 4111,
		_Loop_CoverCheckUp = 4112,
		_Loop_StandCoverCheck = 4116,
		CoverSignGo = 4113,
		StandCoverSignCome = 4117,
		CoverReload = 4114,
		Reload = 4115,
		StandHandSignCome = 32837,
		StandHandSignGo = 32838,
		SquatHandSignCome = 32839,
		SquatHandSignGo = 32840,
		LookAroundAction = 32768,
		_Loop_SquatCautionRest = 32802,
		_Loop_Injured1 = 32832,
		_Loop_Injured2 = 32833,
		_Loop_Injured3 = 32834,
		_Loop_CareTheInjured = 32835,
		SearchGrass = 16389,
	}
	...
	[RTTI.Serializable(0xCD35D4FE54BFEF69, GameType.DS)]
	public enum EDSPlayerActionFlagExported : int32
	{
		...
		COMBO_STATE = 24,
		CAN_USE_FAKE_HOLO = 26,
		USING_FAKE_HOLO = 27,
		CAN_USE_FAKE_HOLO_ACTION = 28,
		VEHICLE_DRIVING = 29,
		CART_DRIVING = 30,
		ENABLE_SUBJECT_CAMERA = 31,
		DISABLE_SUBJECT_CAMERA = 32,
		DISABLE_RESET_CAMERA = 33,
		DISABLE_FALL = 34,
		DISABLE_FALL_ENABLE_CLIFF = 35,
		DISABLE_DASH = 36,
		DISABLE_GUN_HOLD = 37,
		DISABLE_IMPACT_EFF_SLIDE = 38,
		DISABLE_IMPACT_EFF_TRIG = 39,
		USE_SEQ_MOTION = 41,
		USE_BASIC_MOTION = 42,
		INCITE_TAKE_A_BREAK = 43,
		FORCE_BASIC_SLOPE_IS_PLANE = 44,
		FORCE_SLOPE_IS_PLANE = 45,
		USE_MOVE_SLOPE_FRONT_IS_STICK = 46,
		TURN = 47,
		TOUCH_WALL = 48,
		HIGGS_PHASE3_MODE = 49,
		ROPE_MOVE_PLANE_BACK = 50,
		ROPE_MOVE_CLIMB_UP = 51,
		ECO_MOTION = 52,
		ECO_MOTION_PLAY_VOICE = 53,
		UpperLookMission = 54,
		USE_FORCE_BRAKE_MOVE = 55,
		HUGE_CATCHER_ABSORB_GUN_ATTACK_TIME = 56,
		CLIFF_MODE = 57,
		HUGE_ABSORB_FAILD_TO_FALL = 58,
		VIEW_CLIFF_EDGE = 59,
		AUTO_STEP_DOWN = 60,
		AUTO_STEP_ON = 61,
		FALL_CHECK_IS_LONG = 62,
		CLIFF_IS_NONE_SAFE_ACTION_AREA = 63,
		CART_IS_DRAG_BAT_NOT_ATTACH = 64,
		FOOT_IMPACT_IS_ONESELF_MODE = 65,
		FOOT_IMPACT_IS_SLIDE_MODE = 66,
		BREATH_OUT_DOWN = 67,
		PRE_TIRE_IDLE = 68,
		HUNTER_DRAG_TO_BACK = 69,
		IN_AIR = 70,
		FALLING = 71,
		EVASION = 72,
		TAKE_A_BREAK_INVISIBLE_BAGGAGE = 74,
		WAIT_DEATH_FROM_DAMAGE = 75,
		ATTACK_MODE = 76,
		AIM_MODE = 77,
		AIM_TURN = 79,
		USE_UPPER_AIM_MOTION = 80,
		CAN_CHANGE_HOLD_GUN_MODE = 81,
		RELOAD_READY = 82,
		RELOAD_MODE = 83,
		UNHOLD_GUN_AIM_MODE = 84,
		ENABLE_KEEP_AIM_POSE = 85,
		CAN_FIRE_ACTION = 86,
		FIRING = 87,
		CAN_EVADE_TO_FAST_ATTACK = 88,
		TAKE_A_BREAK = 89,
		TAKE_A_BREAK_SLEEPING_STATE = 90,
		TAKE_A_BREAK_SLEEPING = 91,
		TAKE_A_BREAK_NAP = 92,
		TAKE_A_BREAK_IS_CROUCH = 93,
		TAKE_A_BREAK_IS_SITDOWN = 94,
		OKAN_MOTION = 95,
		GUARD_MODE = 96,
		GUARD_MODE_RIGHT = 97,
		GUARD_MODE_LEFT = 98,
		GUARD_MODE_INTERRUPTION_READY = 99,
		GUARD_MODE_INTERRUPTION = 100,
		GUARD_MODE_RIGHT_ACTIVE = 101,
		GUARD_MODE_LEFT_ACTIVE = 102,
		GUARD_MODE_RIGHT_ACTIVE_HOLDED = 103,
		GUARD_MODE_LEFT_ACTIVE_HOLDED = 104,
		TRY_GUARD_MODE = 105,
		TRY_GUARD_IS_LEFT = 106,
		TRY_GUARD_IS_RIGHT = 107,
		TRY_GUARD_IS_MOST_SAFETY = 108,
		REQUEST_GUARD_MODE_LEFT_ICON = 109,
		REQUEST_GUARD_MODE_RIGHT_ICON = 110,
		REQUEST_GUARD_MODE_LEFT_ICON_SHOW_ONLY = 111,
		REQUEST_GUARD_MODE_RIGHT_ICON_SHOW_ONLY = 112,
		REQUEST_GUARD_MODE_ICON_IS_STOP = 113,
		STOP_BREATH_LEFT = 114,
		STOP_BREATH_RIGHT = 115,
		STOP_BREATH_LEFT_ACTIVE = 116,
		STOP_BREATH_RIGHT_ACTIVE = 117,
		STOP_BREATH_LEFT_HAND_LOWER = 118,
		STOP_BREATH_HARD = 119,
		CRYPTO_EATING_LEFT = 120,
		CRYPTO_EATING_RIGHT = 121,
		CRYPTO_GETING_LEFT = 122,
		CRYPTO_GETING_RIGHT = 123,
		WAKED_HAND_CUFF_TERMINAL = 124,
		WAKED_HAND_CUFF_TERMINAL_KEEP_ACTION = 125,
		WAKED_HAND_CUFF_TERMINAL_KEEP_ACTION_WAKE_FRAME = 126,
		HAND_CUFF_TERMINAL_USE_MOTION = 127,
		NO_TARMINAL_START = 128,
		CAN_TARMINAL_START = 129,
		CAN_TARMINAL_START_AND_MOTION = 130,
		CAN_TARMINAL_START_AND_NO_MOTION = 131,
		CAN_TARMINAL_START_AND_ZIPLINE = 132,
		__0 = 133,
		CAN_TARMINAL_START_AND_DIRECT_CARGO = 134,
		NO_NATURAL_PUBLIC_MOTION = 135,
		TO_GLOVE_TOUCH_EFFECT = 136,
		CAN_LOADING_ACTION_SEAQUENCE_ONCE = 138,
		MOVE_HEADING_TO_TURN_HEADING = 139,
		DANGER_SLOPE_MOVE = 140,
		JUDGE_CATCH_CATCH_BAGGAGE_KEEP_ACTION = 141,
		CAN_CATCH_BAGGAGE_KEEP_ACTION = 142,
		CATCH_BAGGAGE_KEEP_MODE = 143,
		CAN_GUARD_MODE_KEEP_ACTION = 144,
		ENABLE_DASH_CAMERA_SHAKE = 146,
		SPRINT_TO_SLIDING = 147,
		PICKUP_COLLECTIBLE_RIGHT = 148,
		PICKUP_COLLECTIBLE_LEFT = 149,
		PICKUP_READY_BAGGAGE_RIGHT = 150,
		PICKUP_READY_BAGGAGE_LEFT = 151,
		PICKUP_BAGGAGE_RIGHT = 152,
		PICKUP_BAGGAGE_LEFT = 153,
		PICKUP_BAGGAGE_RIGHT_FROM_DELEVERY = 154,
		PICKUP_BAGGAGE_LEFT_FROM_DELEVERY = 155,
		PUT_BAGGAGE_RIGHT = 158,
		PUT_BAGGAGE_LEFT = 159,
		CATCH_BAGGAGE_RIGHT = 160,
		CATCH_BAGGAGE_LEFT = 161,
		PICK_FROM_BACKPACK_RIGHT = 162,
		PICK_FROM_BACKPACK_LEFT = 163,
		SWAP_BAGGAGE = 164,
		FOLD_BAGGAGE_RIGHT = 165,
		FOLD_BAGGAGE_LEFT = 166,
		PACK_BAGGAGE_RIGHT = 167,
		PACK_BAGGAGE_LEFT = 168,
		SWING_BAGGAGE_RIGHT = 169,
		SWING_BAGGAGE_LEFT = 170,
		REQUEST_BAGGAGE_FOLD = 172,
		LOWER_HACK = 173,
		SNS_PLAY = 174,
		HUNTER_SWINGING_L = 176,
		HUNTER_SWINGING_R = 177,
		HUNTER_SWINGING_ATTACKING = 178,
		BELL_DOWN = 180,
		BB_HOLD = 181,
		DOWN_TO_GETUP = 182,
		HIP_DOWN = 183,
		HIP_DOWN_TO_GETUP = 184,
		UNCONSCIOUS_START = 185,
		UNCONSCIOUS_LOOP = 186,
		RIVER_DRIVING = 187,
		RIVER_DRIVING_AND_START = 188,
		WATER_CHECK_FROM_GROUND = 189,
		WATER_CHECK_FROM_HIT_GROUND = 190,
		JUMP_UP = 191,
		JUMP_DOWN = 192,
		LAND_STEP = 193,
		SLIDING_MOTION = 194,
		SLIDING_ROLLING_MOTION = 195,
		SLIDING_STAND_KEEP_MOTION = 196,
		SLIDING_CATCH_GROUND = 197,
		FOOT_SLIP_MOTION = 198,
		DASH_START = 199,
		SLIPPING = 200,
		SLIPPING_RECOVER_SUCCESS = 201,
		UNSTABLE_BALANCE = 202,
		UNSAFE_ACTION = 203,
		LITTLE_SLIP_FALL = 204,
		FOOT_HEAVY_GRAVITY = 205,
		DRAGED_BY_GAZER = 206,
		DRAGGED_BY_GAZER_CAMERA = 207,
		NO_DAMAGE = 208,
		NO_DAMAGE_HIT = 209,
		NEVER_DEAD = 210,
		USING_ROPE = 211,
		USE_SUBJECTIVE_LOOK_IK = 212,
		DODGE_TO_KEEP_DASH = 214,
		RIDE_VEHICLE_HAS_BAGGAGE = 215,
		RIDE_VEHICLE_HAS_BAGGAGE_WITH_DELIVERY_TAG = 216,
		DISABLE_LUNG_RECOVERY = 217,
		DISABLE_CONSCIOUS_RECOVERY = 218,
		BC_STRESS_FULL = 220,
		BC_SEE_GAZER = 221,
		ENABLE_BREATH_HOLD = 222,
		DECREASE_SHOES_DURABILITY = 223,
		DECREASE_STAMINA_BY_MOVING = 224,
		CAN_USE_BAGGAGE_SENSOR = 225,
		CAN_USE_SUITPARTS = 226,
		ODRADEK_CAN_PLAY_ENCOUNTER_ACT = 227,
		FORCE_AIM_MODE = 228,
		DISP_SEND_LIKE_ICON = 229,
		CANNOT_SEND_LIKE = 230,
		DISABLE_PAUSE_MENU = 231,
		VOLATILE_START = 235,
		ENABLE_BACK_INPUT_ONCE = 236,
		FORCE_BACK_INPUT_ONCE = 237,
		MOT_SPEED_COPY_FROM_STOP_SPEED = 238,
		BACK_INPUT_NEVER_STOPOUT_ONCE = 239,
		ADJUST_TO_MOVE_FRAME = 240,
		NO_DAMAGE_ONCE = 241,
		NO_DAMAGE_HIT_ONCE = 242,
		NEVER_DEAD_ONCE = 243,
		DEATH_IS_RAGDOLL_FROM_DAMAGE_ONCE = 244,
		USE_BASIC_HAND_L_IK_ONCE = 247,
		USE_BASIC_HAND_R_IK_ONCE = 248,
		DISABLE_CHANGE_ALL_ONCE = 249,
		DISABLE_UPDATE_MISSION_BAGGAGE_INFOLOG = 250,
		LOWER_HACK_ONCE = 251,
		DUMMY = 252,
		VOLATILE_END = 253,
		FLAG_COUNT = 254,
	...
	[RTTI.Serializable(0x7A724041DE08DC88, GameType.DS)]
	public enum EDSPlayerMesh : int8
	{
		...
		StaminaLamp02 = 92,
		Boots_repealed_ = 94,
		BootsBreak_repealed_ = 95,
		SoleGrass_repealed_ = 96,
		BareFoot_repealed_ = 97,
		Hair = 98,
		HairSuitMule = 99,
		HoodOtterOn = 100,
		HoodOtterOff = 101,
	...
	[RTTI.Serializable(0x9EB08E60E9BF3B27, GameType.DS)]
	public enum EDSPlayerProfileFloatValueType : int8
	{
		MouseHorizontalSensitivity = 0,
		MouseVerticalSensitivity = 1,
		MouseADSHorizontalSensitivity = 2,
		MouseADSVerticalSensitivity = 3,
		MouseFPHorizontalSensitivity = 4,
		MouseFPVerticalSensitivity = 5,
		MouseVehicleHorizontalSensitivity = 6,
		MouseVehicleVerticalSensitivity = 7,
	}

	[RTTI.Serializable(0x5D8F0E460FA002A7, GameType.DS)]
	public enum EDSPlayerProfileValueType : int8
	{
		Version = 0,
		CameraVerticalInput = 1,
		CameraHorizontalInput = 2,
		CameraVerticalSensitiviness = 3,
		CameraHorizontalSensitiviness = 4,
		GuardModeSensitiviness = 5,
		GameDifficulty = 6,
		AutoAim = 7,
		ControllerSpeaker = 8,
		AutoLogin = 9,
		...
		QuickChangeType = 13,
		Vibration = 14,
		StickInputDeadzone = 15,
		ShowMarker = 16,
		ShowReticle = 17,
		ShowActionIcon = 18,
		ShowEquipmentIcon = 19,
		CameraVibration = 20,
		CameraFPVerticalInput = 21,
		CameraFPHorizontalInput = 22,
		CameraFPVerticalSensitiviness = 23,
		CameraFPHorizontalSensitiviness = 24,
		CameraTurnAccel = 25,
		CameraTurnBreak = 26,
		ShowSubtitling = 27,
		MasterVolumeSensitiviness = 28,
		Brightness = 29,
		ControllHoldTime = 30,
		DandlingType = 31,
		GameOverCountForHospitality = 32,
		HDREnable = 33,
		HDRBrightness = 34,
		FontSize = 35,
		OdradekDemoSkip = 36,
		HotKeyDisable = 37,
		MouseCameraHorizontalInput = 38,
		MouseCameraVerticalInput = 39,
		KBDActionToggleADS = 40,
		KBDActionToggleSprint = 41,
		KBDActionToggleWalk = 42,
		KBDActionToggleBreathStop = 43,
		KBDActionToggleFP = 44,
		KBDActionToggleGrab = 45,
		KBDActionToggleBrace = 46,
		GamePadActionToggleADS = 47,
		GamePadActionToggleSprint = 48,
		GamePadActionToggleGrab = 49,
		GamePadActionToggleBrace = 50,
		GamePadSwapDecideAndCancel = 51,
		ControllerBtnIconType = 54,
		BtnIconSwitchType = 55,
		UpdateInfoLastIndex = 52,
		KBDActionWalkSensitivity = 53,
		PhotoModeEnable = 56,
		SyncGameObject = 57,
		ShowTutorialTelop = 58,
		GraphicQuality = 59,
		CameraADSVerticalSensitiviness = 60,
		CameraADSHorizontalSensitiviness = 61,
		CameraVehicleVerticalSensitiviness = 62,
		CameraVehicleHorizontalSensitiviness = 63,
		MapTiltType = 64,
		MouseMenuDicideActType = 65,
		PhotoModeKeepParams = 66,
		VisibleFPS = 67,
		VisibleVRAM = 68,
		SoundLocalization = 69,
		KBDActionGuardModeSensitivity = 70,
		UIKeyboardLayout = 71,
		WindowMode = 75,
		VerticalSync = 76,
		DisplayMonitor = 77,
		...
		ModelDetail = 81,
		StreamMemory = 82,
		UseGraphicsMemory = 83,
		ShadowResolution = 84,
		ScreenSpaceReflection = 85,
		AmbientOcclusion = 86,
		AntiAliasing = 87,
		AMD_CAS = 88,
		NVIDIA_DLSS = 89,
	...
	[RTTI.Serializable(0x291695E19EC2409A, GameType.DS)]
	public enum EDSRoadConstructionEffectEventType : int8
	{
		Attach = 0,
		StartEffectToBack = 1,
		StartEffectToForward = 2,
		ForceVisible = 3,
		ForceInvisible = 4,
		Detach = 5,
		AllReset = 6,
	...
	[RTTI.Serializable(0x9C4632C76AAA1236, GameType.DS)]
	public enum EDSSharedEnvironmentalObstacleType : int16
	{
		SMALL_ROCK = 8,
		MID_ROCK = 9,
		LARGE_ROCK = 10,
	...
	[RTTI.Serializable(0x69409DAC7E5AAC9C, GameType.DS)]
	...
	[RTTI.Serializable(0x525003E26467E6, GameType.DS)]
	public enum EDSSpaColorExported : int32
	{
		WhiteMilky = 0,
		Red = 1,
		Brown = 2,
	...
	[RTTI.Serializable(0x47024D0885E0951F, GameType.DS)]
	...
	[RTTI.Serializable(0x884F2544B2598CDD, GameType.DS)]
	public enum EDSUIActionLocalizedId : int32
	{
		...
		WearValve = 205,
		WearHeadCrab = 206,
		WearGlassesJohnny = 207,
		RemoveGlassesGordon = 208,
		RemoveValve = 209,
		RemoveHeadCrab = 210,
		RemoveGlassesJohnny = 211,
	}

	[RTTI.Serializable(0x47AE80FA56961618, GameType.DS)]
	public enum EDSUIAimHUDComponentAnimeType : uint32
		{
		Unset = 4294967295,
		Idle = 0,
		SwitchToEffective = 1,
	...
	[RTTI.Serializable(0xC6E3E02714B811D1, GameType.DS)]
	public enum EDSUICommonDialogueButtonType : int8
	{
		None = 0,
		OK = 1,
		Yes = 2,
	...
	[RTTI.Serializable(0x2D95653103493561, GameType.DS)]
	public enum EDSUICommonRadioType : int8
	{
		Invalid = -1,
		Common = 0,
	}
	...
	[RTTI.Serializable(0xA87457199111F4ED, GameType.DS)]
	public enum EDSUIConfigMenuCategory : int8
	{
		None = -1,
		Game = 0,
		GamePad = 1,
	...
	[RTTI.Serializable(0xDF25265AA749864F, GameType.DS)]
	public enum EDSUIDPadHUDDisplaySceneType : int32
	{
		WALK = 0,
		IDLE = 1,
		RIDE_VEHICLE = 2,
	...
	[RTTI.Serializable(0xCACE349068DA29B6, GameType.DS)]
	public enum EDSUIDemoSequence : int8
	{
		None = 0,
		CutScene_PostEntity_Immediately = 1,
		CutScene_PostEntity_Normal = 2,
		CutScene_Update_Immediately = 3,
		CutScene_Update_Normal = 4,
		InGameCutScene_PostEntity_Immediately = 5,
		InGameCutScene_PostEntity_Normal = 6,
		InGameCutScene_Update_Immediately = 7,
		InGameCutScene_Update_Normal = 8,
		Max = 9,
	}

	[RTTI.Serializable(0x875D01E99CDA982, GameType.DS)]
	public enum EDSUIDeviceHelpId : int32
	{
		leftstick = 0,
		rightstick = 1,
		leftstickpress = 2,
	...
	[RTTI.Serializable(0xFC55C0873A02CF33, GameType.DS)]
	public enum EDSUIDeviceMenuMode : int8
	{
		None = 0,
		HandcuffsDevice = 1,
		DeliveryDevice = 2,
		OrderFlow = 3,
		PrivateRoomPreparation = 4,
	}
	...
	[RTTI.Serializable(0xB21123DA3D43870A, GameType.DS)]
	public enum EDSUIFadeOwner : int8
	{
		Invalid = 0,
		Program = 1,
		SequenceEvent = 2,
	...
	[RTTI.Serializable(0xFA2052AC609B241E, GameType.DS)]
	public enum EDSUIFadeState : int8
	{
		InGame = 0,
		FadeOutPlaying = 1,
		FadeOutFinished = 2,
	...
	[RTTI.Serializable(0x5A7E40E29B958721, GameType.DS)]
	public enum EDSUIFadeVersion : int8
	{
		HUDVersion = 0,
		ScreenEffectVersion = 1,
	}

	[RTTI.Serializable(0x3223BDDEC33553EC, GameType.DS)]
	public enum EDSUIGamepadType : int8
	{
		Default = 0,
		TypeA = 1,
		TypeB = 2,
	...
	[RTTI.Serializable(0x41D418A6E98D1284, GameType.DS)]
	public enum EDSUIHUDCameraZoomMode : int8
	{
		Unset = 0,
		Normal = 1,
		ZoomOut = 2,
	...
	[RTTI.Serializable(0x617BD8432193C4AE, GameType.DS)]
	public enum EDSUIHackingNGReason : int8
	{
		OutOfRange = 0,
		BatteryMissing = 1,
		Hacked = 2,
	...
	[RTTI.Serializable(0xF667F4B9F24EEC7D, GameType.DS)]
	public enum EDSUIHackingStatus : int8
	{
		None = 0,
		Analyzing = 1,
		Analyzed = 2,
	...
	[RTTI.Serializable(0x923FFAE44D96EDBA, GameType.DS)]
	public enum EDSUIHackingTarget : int8
	{
		None = 0,
		DestinationON = 1,
		DestinationOFF = 2,
	...
	[RTTI.Serializable(0xAF20A60B41369DC3, GameType.DS)]
	public enum EDSUIInfoLogHUDDisplayableState : int8
	{
		Default = 0,
		DelayPhase = 1,
		GameOver = 2,
		...
		Beach = 6,
		LookingBB = 7,
		PrivateRoomCureGauge = 8,
		PrivateRoom = 9,
		PrivateRoom_NotStay = 10,
		TerminalCutScene = 11,
		CutSceneAndInGameCutScene = 12,
		Warriors = 13,
		BossCatcherBattle = 14,
		AdrenalineMode = 15,
	}
	...
	[RTTI.Serializable(0x411F15066AE81075, GameType.DS)]
	public enum EDSUIKeyHelpIconDeviceType : int8
	{
		Unspecified = 0,
		Gamepad = 1,
		MouseKeyboard = 2,
	...
	[RTTI.Serializable(0x3CCE2DFEFCB71E83, GameType.DS)]
	public enum EDSUIKeyHelpIconInputStyle : int8
	{
		Normal = 0,
		Hold = 1,
	}

	[RTTI.Serializable(0xDC5DAE632FF14994, GameType.DS)]
	public enum EDSUIMailFilter : int32
	{
		ALL = 0,
		IMPORTANT = 1,
		BYSENDER = 2,
	...
	[RTTI.Serializable(0xEC67F5DF37ABBA7, GameType.DS)]
	public enum EDSUIMapParts : int8
	{
		ParallaxParts = 0,
		ParallaxIconParts = 1,
		IconItemParts = 2,
	...
	[RTTI.Serializable(0x592CB763445A1684, GameType.DS)]
	public enum EDSUIMenuPageId : int8
	{
		DeviceMenu = 0,
		GameOverMenu = 1,
		DemoPauseMenu = 2,
		InGamePauseMenu = 3,
		CommonDialogueMenu = 6,
		LoadingScreenMenu = 7,
		TitleMenu = 8,
		SplashScreenMenu = 9,
		SignboardMenu = 10,
	...
	[RTTI.Serializable(0xFFA2C3E0B51F6C33, GameType.DS)]
	public enum EDSUIMenuSoundId : int32
	{
		MENU_SOUND_BEEP = 0,
		MENU_SOUND_CURSOR = 1,
		MENU_SOUND_ACCEPT = 2,
		MENU_SOUND_CANCEL = 3,
		MENU_SOUND_LOADING_MUSIC = 4,
		MENU_SOUND_RESULT_MUSIC = 5,
		MENU_SOUND_MAX = 6,
	}
	...
	[RTTI.Serializable(0xD859498128C2BB5D, GameType.DS)]
	public enum EDSUIMissionBaggageRadioType : int8
	{
		Invalid = -1,
		OrderBaggage = 0,
		SupplyBaggage = 1,
	...
	[RTTI.Serializable(0x29E1003BADB80A08, GameType.DS)]
	public enum EDSUIMissionResultListEventType : int8
	{
		Unknown = 0,
		Show = 1,
		ShowAnimationStart = 2,
		ShowAnimationEnd = 3,
		Hide = 4,
		HideAnimationStart = 5,
		HideAnimationEnd = 6,
		CountStart = 7,
		CountEnd = 8,
		FocusOnAnimationStart = 9,
		FocusOnAnimationEnd = 10,
		FocusOffAnimationStart = 11,
		FocusOffAnimationEnd = 12,
		StarGraphRequestEnd = 13,
		Accept = 14,
	}

	[RTTI.Serializable(0xAF916D7E8339C02E, GameType.DS)]
	public enum EDSUIMissionResultListNoticeType : int8
	{
		Unknown = 0,
		MainTitle = 1,
		TitleColumn = 2,
		DefaultColumn = 3,
		DefaultColumn_Title = 4,
		DefaultColumn_Score = 5,
		DefaultColumn_Strand = 6,
		DefaultColumn_Rank = 7,
		DefaultColumn_Like = 8,
		BaggageDialog = 9,
		BaggageDialog_Info = 10,
		BaggageDialog_Column = 11,
		BaggageDialog_Count_Effect = 12,
		BaggageDialog_BaseLike = 13,
		BaggageDialog_Like = 14,
		BaggageDialog_Rank = 15,
		TotalLikeCounter = 16,
		AddLikeCounter = 17,
		LikeAndFriendshipPopup = 18,
		FriendshpStarGauge = 19,
		FriendshpStarGauge_LevelUp = 20,
		OverallSymbol = 21,
		NickNamePlate = 22,
		NickNamePlateEffect = 23,
		NickNamePlateRefresh = 24,
		PoeterEvaluationList = 25,
		PoeterEvaluationList_Column = 26,
		StarGraphDeactiveDemo = 27,
		StarGraphGaugeDemo = 28,
		StarGraphPartsDemo = 29,
		Dialog = 30,
	}
	...
	[RTTI.Serializable(0xD7DC0A6A84C8EA88, GameType.DS)]
	public enum EDSUIPlayerStatusGauge : int8
	{
		Speed = 0,
		Endurance = 1,
		RoadAbility = 2,
	...
	[RTTI.Serializable(0x1D21A5055C9CBA26, GameType.DS)]
	public enum EDSUIResidentRadioType : int8
	{
		Invalid = -1,
		Intro = 0,
		SimpleIntro = 1,
		RoadRebuilderMenuOpen = 2,
		SafetyHouseMenuOpen = 3,
		AutoDeliveryMenuOpen = 4,
		PrivateRoomMenuOpen = 5,
		MissionTypeSelect = 6,
		AtSelectDelivery_CanDeliveryLost = 7,
		AtSelectBaggage_IfConsignable = 8,
		AtSelectMission_HasReturnedSimpleMissionBaggage_SameTerminal = 9,
		AtSelectMission_HasReturnedSimpleMissionBaggage_OtherTerminal = 10,
		AtSelectMission_HasReturnedDynamicLostBaggage_SameTerminal = 11,
		AtSelectMission_HasReturnedDynamicLostBaggage_OtherTerminal = 12,
		UnlockedDeleteBridge = 13,
		UnlockedDeleteSafehouse = 14,
		AtSelectShareBox = 15,
		AtSelectPrivateBox = 16,
		AtSelectShareBox_IfHasReturnedBaggage = 17,
		AtSelectShareBox_IfHasOnlineLostBaggage = 18,
		AtSelectMission_IfCanSimpleMission = 19,
		InOrderMenu_AtOpenSupplyMissionDetail = 20,
		InOrderMenu_AtOpenMaterialMissionDetail = 21,
		DelivaryMenuOpen_IfCatalogueActive = 22,
		DeliveryMenuOpen_IfMissionTodoUnupdated = 23,
		VehicleMenuOpen_IfHasOtherPlayerVehicle = 24,
		BaggageMenuOpen_IfHasTrash = 25,
		DeviceMenuOpen_IfHasReturnedBaggage = 26,
		DeviceMenuOpen_IfShownHasReturnedBaggageIcon = 27,
		DeviceMenuOpen_IfShownHasPrivateBoxBaggageIcon = 28,
		DeviceMenuOpen_IfShownHasShareBoxBaggageIcon = 29,
		DeviceMenuOpen_IfShownStructureBrokenIcon = 30,
		WeatherNews1 = 31,
		WeatherNews2 = 32,
		MaterialDialogOpen = 33,
		GiftMenuOpen_IfHasGift = 34,
		JoinUCADialogOpen = 35,
		ResultFriendLv3 = 36,
		HandOver_PartiallyDelivery = 37,
		HandOver_Consign = 38,
		SupplyMissionOpen = 39,
		BridgeLinkOpen = 40,
		QpidResult_PacketUp = 41,
		AtSelectPrivateBox_NearDelete = 42,
		MapTerminalIconCardOpen = 43,
		MapStructureIconCardOpen_CanLvup = 44,
		MusicPlayerOpen = 45,
		AtSelectPrivateBox_MoreDelete1 = 46,
		AtSelectPrivateBox_MoreDelete2 = 47,
		StructureCooperationRequest = 48,
		AutobotMissionOpen = 49,
	}

	[RTTI.Serializable(0xDB04A79E1CA313FB, GameType.DS)]
	public enum EDSUISaveLoadIconState : int8
	{
		NONE = 0,
		INTRO = 1,
		IDLE = 2,
	...
	[RTTI.Serializable(0x33F8AE647750483, GameType.DS)]
	public enum EDSUISaveLoadIconType : int8
	{
		SAVING = 1,
		LOADING = 0,
	...
	[RTTI.Serializable(0x3CB72934FE240C65, GameType.DS)]
	public enum EDSUISequence : int8
	{
		Default = 0,
		FadeInOut = 1,
		PhotoMode = 2,
		...
		CureGaugeMenu = 7,
		HeartmanRoom = 8,
		WeaponSelectorTutorial = 9,
		WaitingInfoLog = 10,
		InDemo = 11,
		TerminalOperation = 12,
		DirectIntoPrivateRoom = 13,
		HandcuffDevice = 14,
		KnotSpace = 15,
		GameOver = 16,
		Annihilation = 17,
	...
	[RTTI.Serializable(0xB991DB6236CF3278, GameType.DS)]
	public enum EDSUIStarGraphMenuRequestType : int8
	{
		None = 0,
		StarDeactiveDemo = 1,
		GaugeDemo = 2,
	...
	[RTTI.Serializable(0x6BE709CB397F464, GameType.DS)]
	public enum EDSUIUnlockDialogCategory : int8
	{
		QpidConnectPerson = 0,
		MenuOpenWithQpid = 1,
		Memorychip = 2,
	...
	[RTTI.Serializable(0xEF6EB30FBCA02993, GameType.DS)]
	public enum EDSUIWishMenuTabType : int32
	{
		NEW = 0,
		DELIVERY_MACHINE = 1,
		EQUIPMENT = 2,
		WEAPON = 3,
		RAW_MATERIAL = 4,
		RAW_MATERIAL_CRYSTAL = 5,
		RAW_MATERIAL_RESIN = 6,
		RAW_MATERIAL_METAL = 7,
		RAW_MATERIAL_CERAMIC = 8,
		RAW_MATERIAL_CHEMICALS = 9,
		RAW_MATERIAL_ALLOY = 10,
		BACKPACK = 11,
		VEHICLE = 12,
	}
	...
	[RTTI.Serializable(0xFF5A464BAC3CA17E, GameType.DS)]
	public enum EDSUserPlayMeasurementType : int8
	{
		AbsoluteTime = 0,
		MissionTime = 1,
		InGameTime = 2,
	...
	[RTTI.Serializable(0xE5A7F9AF43EC5C92, GameType.DS)]
	public enum EDSUserPlayTimerType : int8
	{
		UserPlay = 0,
		Living = 1,
		Beach = 2,
	...
	public enum EDSWeaponConnectPoint : uint32
	{
		Invalid = 4294967295,
		StandardMuzzle = 0,
		SuppressorMuzzle = 1,
	...
	[RTTI.Serializable(0x4DA1239D6018257, GameType.DS)]
	...
	[RTTI.Serializable(0xDD1CF5F847F285DC, GameType.DS)]
	...
	[RTTI.Serializable(0xBF6855C3460E814C, GameType.DS)]
	...
	[RTTI.Serializable(0x785E8123CE93CA0F, GameType.DS)]
	public enum EDebugRendererMode : int32
	{
		...
		OmniShadow = 20,
		TransparentOnly = 21,
		VolumeLightBuffer = 22,
		SunLightShafts = 23,
		VolumeAmount0 = 24,
		VolumeAmount1 = 25,
		VolumeAmount2 = 26,
		VolumeAmount3 = 27,
		VolumeLightAmount3D = 28,
		AlbedoNoBlit = 29,
		LightComplexity = 30,
		DoFCoC = 31,
	}

	[RTTI.Serializable(0x682ECE4AF006126F, GameType.DS)]
	public enum EDebugViewportMode : int8
	{
		FullScreen = 0,
		TopLeft = 1,
		TopRight = 2,
	...
	[RTTI.Serializable(0x1BC80C9387723BD3, GameType.DS)]
	public enum EDefaultShader : int8
	{
		...
		DropShadow = 7,
		ConstantColor = 8,
		ConstantColorInstanced = 9,
		ConstantColorLight = 10,
		ConstantColorNormal = 11,
		DSConstantFourColorNormal = 12,
		SkyClear = 13,
		Filter4 = 14,
		Filter8 = 15,
		Filter16 = 16,
		TextureRectDiffuse = 17,
		TextureRectDiffuseMRT = 18,
		TextureUIntRectDiffuse = 19,
		Glyphs = 20,
		DepthBuffer = 21,
		DepthBufferOutput = 22,
		DepthCubemapBufferOutput = 23,
		TextureAntiAliased = 24,
		InitProgress = 25,
		YUVToRGB = 26,
		TextureMasked = 27,
		TexRectSwizzled = 28,
	...
	[RTTI.Serializable(0x16B361784FB95C40, GameType.DS)]
	public enum EDeferredMaterialID : int32
	{
		...
		DEFERRED_MATERIAL_ID_CUSTOM_FORWARD = 5,
		DEFERRED_MATERIAL_ID_MUSUBIME_OCEAN = 6,
	}

	[RTTI.Serializable(0x403D62E94802461B, GameType.DS)]
	...
	[RTTI.Serializable(0x652AA85099DF66E8, GameType.DS)]
	public enum EDepthOfFieldOption : int8
	{
		BestInputDepth = 1,
		NewNearCoCCurve = 2,
		NewTechnique = 4,
	...
	[RTTI.Serializable(0xBFC2F715E06C2ADC, GameType.DS)]
	...
	[RTTI.Serializable(0x5B08F8E5FDCB8533, GameType.DS)]
	public enum EDesignerMode : int32
	{
		Disabled = 0,
		Normal = 1,
		AlbedoOnly = 2,
	...
	[RTTI.Serializable(0x3D00E6FE46304207, GameType.DS)]
	...
	[RTTI.Serializable(0xDE14EE0A720485DE, GameType.DS)]
	public enum EDrawPolyCheckerboardUVSource : int32
	{
		None = 0,
		ScreenPos = 1,
		ViewPos = 2,
	...
	[RTTI.Serializable(0x272C5E2AED757E17, GameType.DS)]
	public enum EEnvironmentInteractionRenderType : uint32
	{
		Snow = 1,
	...
	[RTTI.Serializable(0x875632E40EA1CD46, GameType.DS)]
	public enum EExposureCompensationMode : int32
	{
		Disabled = 0,
		Enabled = 1,
		Auto = 2,
	...
	[RTTI.Serializable(0xCC352FB24997C46A, GameType.DS)]
	...
	[RTTI.Serializable(0x539EEDF563B41FEC, GameType.DS)]
	...
	[RTTI.Serializable(0x407712A3DAFA0FE8, GameType.DS)]
	...
	[RTTI.Serializable(0xC38F363C4F85971F, GameType.DS)]
	...
	[RTTI.Serializable(0x85298F2703A2AC99, GameType.DS)]
	...
	[RTTI.Serializable(0x395FF7E4B4C1F759, GameType.DS)]
	...
	[RTTI.Serializable(0x72143263F476C8EE, GameType.DS)]
	...
	[RTTI.Serializable(0x4447B99474008923, GameType.DS)]
	...
	[RTTI.Serializable(0x613076D77344FB9F, GameType.DS)]
	...
	[RTTI.Serializable(0xB3CEF6E32F24DD86, GameType.DS)]
	...
	[RTTI.Serializable(0x4C8104B2E2CDA797, GameType.DS)]
	...
	[RTTI.Serializable(0xAF993E6A450E1AEA, GameType.DS)]
	...
	[RTTI.Serializable(0x8C8AC29597D9247B, GameType.DS)]
	...
	[RTTI.Serializable(0x2A3895383ADAD4BA, GameType.DS)]
	...
	[RTTI.Serializable(0xEB209BA9977D61EA, GameType.DS)]
	...
	[RTTI.Serializable(0x76B127086C01CEF9, GameType.DS)]
	...
	[RTTI.Serializable(0x46B0DDAD793A5286, GameType.DS)]
	...
	[RTTI.Serializable(0xBA6463950166285F, GameType.DS)]
	public enum EInlineSystemFont : int8
	{
		DejaVuSans = 0,
		DejaVuSansItalic = 1,
		Roboto = 2,
	...
	[RTTI.Serializable(0x79B6BE63455B9553, GameType.DS)]
	public enum EInteractionState : int8
	{
		Active = 0,
		Idle = 1,
		TransitionToIdle = 2,
	...
	[RTTI.Serializable(0x2FE27B86564F4F56, GameType.DS)]
	public enum EInventoryItemDropType : int8
	{
		Singular = 0,
		Collection = 1,
	}
	...
	[RTTI.Serializable(0x2C38B66553207355, GameType.DS)]
	public enum EInventorySelectionType : int32
	{
		InventorySelectionAmmo = 0,
		InventorySelectionWeapons = 1,
		InventorySelectionTools = 2,
	}

	[RTTI.Serializable(0x9F99863CE9E20975, GameType.DS)]
	...
	[RTTI.Serializable(0xFF53352165E2006B, GameType.DS)]
	...
	[RTTI.Serializable(0x82FD61A5A0AC07B5, GameType.DS)]
	...
	[RTTI.Serializable(0x433B84DBC7318DFA, GameType.DS)]
	public enum EKeyModifier : int32
	{
		_0 = 0,
		Alt = 1,
		Control = 2,
	...
	[RTTI.Serializable(0xB64BF5DAED22C567, GameType.DS)]
	...
	[RTTI.Serializable(0x8443BFF5D34450CA, GameType.DS)]
	...
	[RTTI.Serializable(0xE1E3789176186EBE, GameType.DS)]
	...
	[RTTI.Serializable(0xA64BAF598619301B, GameType.DS)]
	...
	[RTTI.Serializable(0xBDCAD387A98F10EF, GameType.DS)]
	...
	[RTTI.Serializable(0x9AFDD82520028B49, GameType.DS)]
	...
	[RTTI.Serializable(0x1279929AF69E915E, GameType.DS)]
	...
	[RTTI.Serializable(0x44CC2E6DEEB29E03, GameType.DS)]
	...
	[RTTI.Serializable(0x1EBE09B6068215B, GameType.DS)]
	...
	[RTTI.Serializable(0x4C3FDD2A267286D5, GameType.DS)]
	...
	[RTTI.Serializable(0x1D4B1C904C99AFAA, GameType.DS)]
	...
	[RTTI.Serializable(0xFE83C6D8ADF5450B, GameType.DS)]
	public enum EMaterialRenderingMode : int32
	{
		Regular = 0,
		CustomDeferredBackground = 1,
		CustomDeferred = 2,
		Sky = 3,
		Decal = 4,
		ForwardWater = 5,
		ForwardWaterFromBelow = 6,
		ForwardPreColorize = 7,
		ForwardBackground = 8,
		ForwardForeground = 9,
		ForwardHalfRes = 10,
		ForwardQuarterRes = 11,
		ForwardHalfQuarterRes = 12,
		ForwardMultiRes = 13,
		VolumeLightAmount = 14,
		DeferredTransparent = 15,
		ShadowPassOnly = 17,
		HUD = 16,
	}

	[RTTI.Serializable(0xA65B1B489BEE2B7E, GameType.DS)]
	...
	[RTTI.Serializable(0x1D3D4E772173C40E, GameType.DS)]
	...
	[RTTI.Serializable(0x2C3761A1C1C45578, GameType.DS)]
	public enum EMeleeWeaponAttackType : int32
	{
		Invalid = -1,
		Light = 0,
		Heavy = 1,
	...
	[RTTI.Serializable(0x8E5AB6BFB550B0D2, GameType.DS)]
	...
	[RTTI.Serializable(0x3E65A20958787973, GameType.DS)]
	...
	[RTTI.Serializable(0xDF04DF7AA4EB0A0F, GameType.DS)]
	...
	[RTTI.Serializable(0xD264366570C77E12, GameType.DS)]
	...
	[RTTI.Serializable(0xAC513AF3B50ADE35, GameType.DS)]
	public enum EModifiyMeshParameterSampleOcillatorType : int32
	{
		None = 0,
		Square = 1,
		Sine = 2,
	...
	[RTTI.Serializable(0x981608BC082418C6, GameType.DS)]
	...
	[RTTI.Serializable(0xDBA18D6B9F6EC14C, GameType.DS)]
	...
	[RTTI.Serializable(0x19813B25F9BA2283, GameType.DS)]
	...
	[RTTI.Serializable(0xFC9C4B51F53EE145, GameType.DS)]
	...
	[RTTI.Serializable(0x5BC0799B67DF19B6, GameType.DS)]
	public enum EMouseCursor : int8
	{
		Arrow = 0,
		UpArrow = 1,
		Cross = 2,
	...
	[RTTI.Serializable(0x8C85EBC2066F301E, GameType.DS)]
	...
	[RTTI.Serializable(0x28CCD2E7556E152B, GameType.DS)]
	...
	[RTTI.Serializable(0xF45F6110142A79CD, GameType.DS)]
	public enum EMuleDownType : int32
	{
		Faint = 0,
		Sleeping = 1,
		Restrained = 2,
	...
	[RTTI.Serializable(0xF0D02B3CA270E5D9, GameType.DS)]
	...
	[RTTI.Serializable(0x9DD8702AA5492DF8, GameType.DS)]
	...
	[RTTI.Serializable(0xF3630E1E2ED050DC, GameType.DS)]
	...
	[RTTI.Serializable(0xD07AB9F6D639C50, GameType.DS)]
	public enum ENodeConnectorUnit : int8
	{
		None = 0,
		Time__seconds_ = 1,
		Mass__kilograms_ = 2,
	...
	[RTTI.Serializable(0xFFE9F266486A082B, GameType.DS)]
	public enum EOAuthKeys : int8
	{
		...
		oauth_nonce = 5,
		oauth_token = 6,
		oauth_token_secret = 7,
		oauth_expires_in = 8,
		oauth_session_handle = 10,
		oauth_authorization_expires_in = 9,
		oauth_problem = 11,
	}
	...
	[RTTI.Serializable(0xC0BC3F1A31EC60ED, GameType.DS)]
	...
	[RTTI.Serializable(0xAD26B74C65E923D8, GameType.DS)]
	...
	[RTTI.Serializable(0x4DBD4E608C8A9DCF, GameType.DS)]
	...
	[RTTI.Serializable(0x81DC84A6E87B22A0, GameType.DS)]
	...
	[RTTI.Serializable(0x41F3973C1ACB9C14, GameType.DS)]
	public enum EPackFileCategory : int32
	{
		Invalid = -1,
		Initial = 0,
		Area00 = 1,
	...
	[RTTI.Serializable(0xB8DEEFEC28242FCB, GameType.DS)]
	...
	[RTTI.Serializable(0xB0988F0D18309559, GameType.DS)]
	...
	[RTTI.Serializable(0xF36D36A4F72C5823, GameType.DS)]
	...
	[RTTI.Serializable(0xBAA975678A7688FB, GameType.DS)]
	...
	[RTTI.Serializable(0x8B86844CA7B446AE, GameType.DS)]
	...
	[RTTI.Serializable(0x75E6060BF6B80160, GameType.DS)]
	public enum EPipelinePasses : int32
	{
		...
		Sunlight = 256,
		Lights = 512,
		CustomForward = 134217728,
		FullFwd = 1024,
		FullFwdFrgrndBforWater = 2048,
		LowFwdBforWater = 4096,
		FullFwdBackgroundBforWater = 8192,
		FullFwdFrgrnd = 16384,
		LowFwd = 32768,
		FullFwdBackground = 65536,
		FullFwdWaterFromBelow = 131072,
		Colorize = 262144,
		SSAOAndIndirect = 524288,
		Reflection = 1048576,
		BlurVolumelights = 2097152,
		LightSampling = 4194304,
		VolumeLightAmount = 8388608,
		DownscalePreFwd = 16777216,
		Clouds = 33554432,
		DistantCubemap = 67108864,
		GeometryCustomBackground = 268435456,
		GeometryCustomNormalRead = 536870912,
		GeometryCustomDepthWrite = 1073741824,
	}
	...
	[RTTI.Serializable(0x83667F7E52B68623, GameType.DS)]
	...
	[RTTI.Serializable(0xD9AC642E67B4EF69, GameType.DS)]
	...
	[RTTI.Serializable(0x7B1255EAE5840B84, GameType.DS)]
	...
	[RTTI.Serializable(0xDEC1C31584EF7425, GameType.DS)]
	...
	[RTTI.Serializable(0x5FC24A1F61E29C89, GameType.DS)]
	public enum EQuickDrawState : int8
	{
		Unavailable = 0,
		Available = 1,
		Active = 2,
	...
	[RTTI.Serializable(0x24DC1F5521E93961, GameType.DS)]
	...
	[RTTI.Serializable(0x20A3D650ADF7422A, GameType.DS)]
	...
	[RTTI.Serializable(0x2CD0E0BCAFAE43F9, GameType.DS)]
	...
	[RTTI.Serializable(0x255B21D736738454, GameType.DS)]
	...
	[RTTI.Serializable(0x1CFA21A4EE111F85, GameType.DS)]
	...
	[RTTI.Serializable(0x8169A82A376E567E, GameType.DS)]
	public enum ERenderOrder : int32
	{
		START_OF_FRAME = 0,
		ORDER_GPU_MEMCPY = 3,
		ORDER_WORLDDATA_SAMPLING = 6,
		ORDER_PRECIPITATION_OCCLUSION = 7,
		PARTICLE_UPDATE_COMPUTE = 8,
		ORDER_FORCEFIELD_COMPUTE = 9,
		IMAGE_BLEND_JOB_COMPUTE = 10,
		PLACEMENT_COMPUTE = 11,
		SKYDOME_UPDATE = 12,
		ORDER_DECAL_CULLING = 13,
		ORDER_PRE_DRAW = 14,
		ORDER_ENV_INTERACTION = 15,
		ORDER_VIEWER_SETUP = 20,
		ORDER_CLEAR = 21,
		ORDER_GEOM = 22,
		ORDER_GEOM_END = 23,
		ORDER_DEBUG_GBUFFER_PRELIGHTS = 26,
		ORDER_WEATHER_SIMULATION = 16,
		ORDER_VOLUME_LIGHT_AMOUNT = 27,
		ORDER_SSAO = 28,
		ORDER_PRELIGHTS = 29,
		ORDER_LIGHT_SAMPLING = 30,
		ORDER_SHADOWS = 31,
		ORDER_SHADOWS_END = 32,
		ORDER_LIGHTS = 33,
		ORDER_LIGHTS_END = 34,
		ORDER_POSTLIGHTS = 35,
		ORDER_CLOUDS = 36,
		ORDER_DEBUG_GBUFFER_POSTLIGHTS = 37,
		ORDER_FULLRESCUSTOMFWD = 39,
		ORDER_BLEND_CUBEMAPS = 40,
		ORDER_REFLECTIONS = 41,
		ORDER_LIGHT_COMPOSE = 42,
		ORDER_FULLRESFWD = 43,
		ORDER_LIGHT_SHAFTS = 44,
		ORDER_COLORIZE = 45,
		ORDER_DISTANT_CUBEMAP = 17,
		ORDER_WATER_SRFREF = 18,
		ORDER_MESH_PAINT = 19,
		DOWNSAMPLE_PREALPHA = 46,
		CLEAR_DRAW_TRANSPARENT_ONLY = 47,
		ORDER_FWDBG = 52,
		ORDER_FWDLOWRES = 53,
		ORDER_FWDFOREGRND = 55,
		ORDER_TONEMAPPING = 56,
		START_OF_AFTER_VIEWPORTS_DO_NOT_USE = 58,
		ORDER_EARLY_AA = 59,
		ORDER_POST_EFFECTS = 60,
		ORDER_GPU_PARTICLE_EMISSION_SYSTEM = 54,
		ORDER_DEBUG_RENDERING = 61,
		ORDER_DEBUG_2D_RENDERING = 62,
		ORDER_PRE_HUD = 63,
		ORDER_HUD = 64,
		DEBUG_FULLSCREEN = 65,
		FINAL_RENDER = 66,
	...
	[RTTI.Serializable(0xAFDC3B9BB801AC09, GameType.DS)]
	...
	[RTTI.Serializable(0x4F8602E71740E711, GameType.DS)]
	...
	[RTTI.Serializable(0x7D32E66E5276DC13, GameType.DS)]
	...
	[RTTI.Serializable(0x50E8486A240FADC3, GameType.DS)]
	...
	[RTTI.Serializable(0x6D74FE13684E37D2, GameType.DS)]
	...
	[RTTI.Serializable(0x9FB463698BC5B354, GameType.DS)]
	public enum ESRTEntryType : int8
	{
		...
		EnvInteractionSnowSampleParams = 29,
		EnvInteractionPrecipOcclusionSampleParams = 30,
		EnvInteractionVegetationSampleParams = 31,
		EnvInteractionGrassSampleParams = 32,
		OffscreenParams = 33,
		DeferredLightSamplingPerPassData = 34,
		GBufferBindings = 35,
		AlbedoBindings = 36,
		NormalBindings = 37,
		ReflectanceBindings = 38,
		DepthStencilBindings = 39,
		AccumulationBindings = 40,
	}

	[RTTI.Serializable(0xFEBC9620FCBBD41C, GameType.DS)]
	...
	[RTTI.Serializable(0xF346141AAB15F404, GameType.DS)]
	...
	[RTTI.Serializable(0xFDA6444D64C0A4F8, GameType.DS)]
	...
	[RTTI.Serializable(0x7F0CAA88C6AF37DB, GameType.DS)]
	...
	[RTTI.Serializable(0xD4288D58599700BC, GameType.DS)]
	...
	[RTTI.Serializable(0x9C665072B60E2BA9, GameType.DS)]
	...
	[RTTI.Serializable(0xBD113E293BEC6FFA, GameType.DS)]
	public enum EScratchUsageID : int8
	{
		...
		SrtData = 42,
		Worldmap = 43,
		GlobalVertexCache = 44,
		WaveformCache = 45,
		ShaderBindingData = 46,
		CBuffers = 47,
		RenderContextComputeList = 48,
		ParticleGpuEmmision = 49,
		Game = 50,
		Count = 51,
	}

	[RTTI.Serializable(0x5199AFA797D249D9, GameType.DS)]
	...
	[RTTI.Serializable(0xE09EAFED654EB665, GameType.DS)]
	...
	[RTTI.Serializable(0xE0DF701A3DDCF942, GameType.DS)]
	public enum EShaderBinaryType : int8
	{
		Undefined = 0,
		PS4_Wave = 1,
		_Proto1 = 2,
	...
	[RTTI.Serializable(0x80B60636D395C94E, GameType.DS)]
	...
	[RTTI.Serializable(0x5860F5022E5A3C18, GameType.DS)]
	...
	public enum ESkipLocationType : uint32
		{
		Invalid = 4294967295,
		Start = 0,
		Intro = 1,
	...
	[RTTI.Serializable(0xC615EFF7138ACDDF, GameType.DS)]
	...
	[RTTI.Serializable(0x4B8FDD0F1A07C029, GameType.DS)]
	...
	[RTTI.Serializable(0x36E4397196298A0F, GameType.DS)]
	public enum ESoundInstanceParameter : int32
	{
		...
		inDistanceToPlayerEntity = 10,
		inOcclusionFactor = 11,
		inObstructionFactor = 12,
		inDryAttenuation = 13,
		inWetAttenuation = 14,
		inBulletsLeft = 15,
		inIsZoomedWeapon = 16,
		...
		inSunHeatLevel = 21,
		inSunExposure = 22,
		inGrenadeCookFactor = 23,
		inImpactMass = 24,
		inImpactStrength = 25,
		inScanningPanSpeed = 26,
		inScanningPanDirection = 27,
		inScanningTiltSpeed = 28,
		inScanningTiltDirection = 29,
		inHasTarget = 30,
		inAimAlignedToTarget = 31,
		inForwardSpeed = 32,
		inStrafeSpeed = 33,
		inPanSpeed = 34,
		inTiltSpeed = 35,
		...
		inIsAlert = 38,
		inIsFiring = 39,
		inIsBeingControlled = 40,
		inIsAntennaDeployed = 41,
		inMountedGunTurnSpeed = 42,
		inMountedGunPitchSpeed = 43,
		inMountedGunIsMounted = 44,
		inVehicleGear = 45,
		inVehicleSpeed = 46,
		inVehicleRpm = 47,
		inVehicleBrakes = 48,
		inVehicleHandBrakes = 49,
		inVehicleGearShift = 50,
		inVehicleGas = 51,
		inVehicleActive = 52,
		inVehicleBoost = 53,
		inVehicleWronkLeft = 54,
		inVehicleWronkRight = 55,
		inVehicleTouchesGround = 56,
		inBreathingFactor = 57,
		inIsHit = 58,
		inUniqueEntityId = 59,
		inOwnerIsEnemyOfPlayer = 60,
		inAimedTowardsPlayer = 61,
		inTriggeredOnListener = 62,
		inTimeSinceEnemyHit = 63,
		inIsSilenced = 64,
		inIsMissileLocked = 65,
		inChargeMagnitude = 66,
		inIsCharged = 67,
		inAmmoChargeLevel = 68,
		inIsOvercharged = 69,
		inAmmoTetherLoad = 70,
		inAmmoTetherState = 71,
		inCrowdNPCCountInArea = 72,
		inIncomingPositionAzimuth = 73,
		inOutgoingPositionAzimuth = 74,
		inProximityFactor = 75,
		inImpactVelocity = 76,
	}

	[RTTI.Serializable(0x9745CADE9A1DDE21, GameType.DS)]
	public enum ESoundInstanceWwiseParameter : int32
	{
		inWwiseGameObjectID = 0,
	}

	[RTTI.Serializable(0xE465FC710CCAF743, GameType.DS)]
	...
	[RTTI.Serializable(0x9C2EF829AB146DC4, GameType.DS)]
	public enum ESoundUpdateGraphParameter : int32
	{
		inDeltaTime = 0,
		inEntity = 1,
		inListenerHeading = 2,
	...
	public enum EStickFunction : uint32
		{
		Invalid = 4294967295,
		Move = 0,
		Look = 1,
	...
	[RTTI.Serializable(0x366D1A4113B6623A, GameType.DS)]
	...
	[RTTI.Serializable(0x72EDC95570A99DB3, GameType.DS)]
	...
	[RTTI.Serializable(0x6F0A81B91F278DEC, GameType.DS)]
	...
	[RTTI.Serializable(0xEB0D08CB1763726E, GameType.DS)]
	public enum ETagEvent : int32
	{
		...
		InputTriggered = 8,
		ChildrenUpdated = 11,
		VirtualKeyboardClosed = 12,
		DataContextUpdated = 9,
		DataProviderUpdated = 10,
		MenuStateChanged = 13,
	}
	...
	[RTTI.Serializable(0xD6E85FE8A5000BF6, GameType.DS)]
	...
	[RTTI.Serializable(0x680AEB7CD2FCCD8, GameType.DS)]
	...
	[RTTI.Serializable(0x34DBDBE70EEE8494, GameType.DS)]
	...
	[RTTI.Serializable(0xFC16FEC3ADEB51A1, GameType.DS)]
	...
	[RTTI.Serializable(0xC1B78D0CDD1FEDDF, GameType.DS)]
	...
	public enum EThreatState : uint32
		{
		none = 4294967295,
	...
	[RTTI.Serializable(0xB97BBD9872077AB7, GameType.DS)]
	...
	public enum EVaultObstacleType : uint32
		{
		Invalid = 4294967295,
		Vertical = 0,
		Horizontal = 1,
	...
	[RTTI.Serializable(0x7347A2A0C59DDAB2, GameType.DS)]
	...
	[RTTI.Serializable(0xD250BB3F1D9D19D6, GameType.DS)]
	public enum EViewportType : int8
	{
		Key = 0,
		SplitScreen = 1,
		Offscreen = 2,
	...
	[RTTI.Serializable(0x84FA65D71051941C, GameType.DS)]
	public enum EWeaponActivationState : int8
	{
		Inactive = 0,
		Deactivating = 1,
		Activating = 2,
	...
	[RTTI.Serializable(0x1AB45417B5CE30D6, GameType.DS)]
	...
	[RTTI.Serializable(0xDBADB525D26CA0A7, GameType.DS)]
	public enum EWeaponOperationRequestResult : int8
	{
		Pending = 0,
		Success = 1,
		Failure = 2,
	...
	[RTTI.Serializable(0xFE7D033233B50A86, GameType.DS)]
	...
	[RTTI.Serializable(0x26E94B3FADE2D242, GameType.DS)]
	...
	[RTTI.Serializable(0x722CEDC534F9AB32, GameType.DS)]
	...
	[RTTI.Serializable(0x5407158BB9429A19, GameType.DS)]
	public enum EWorldDataSampleType : int8
	{
		FloatingPoint = 0,
		SignedInt = 1,
		UnsignedInt = 2,
	...
	public enum EnvironmentInteractionTargets : uint32
	{
		Snow = 1,
		PrecipitationOcclusion = 2,
		Vegetation = 4,
	...
	[RTTI.Serializable(0x13E4D2BCC823CE4, GameType.DS)]
	...
	[RTTI.Serializable(0x16F9FB5E25547156, GameType.DS)]
	...
	[RTTI.Serializable(0xC7CE6D968DAD1102, GameType.DS)]
	...
	[RTTI.Serializable(0xF418FF23E4521A93, GameType.DS)]
